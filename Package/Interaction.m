...
placeUserShip::usage = "placeUserShip[startRaw, endRaw] piazza in UserGrid una nave. startRaw e endRaw sono stringhe di un intero in base UserBase (0..gridSize^2-1), con 0 corrispondente in basso a sinistra. 
